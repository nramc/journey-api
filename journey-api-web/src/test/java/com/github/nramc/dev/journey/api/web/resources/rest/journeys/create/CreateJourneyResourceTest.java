...
import static com.github.nramc.dev.journey.api.journey.web.journeys.JourneyData.NEW_JOURNEY_JSON;
...
class CreateJourneyResourceTest {
    ...
    @BeforeEach
    void setup() {
        when(journeyRepository.save(any())).thenAnswer(answer -> answer.getArgument(0));
    }
