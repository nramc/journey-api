...
public class EmailNotificationService implements NotificationService {
    ...
    public void notify(@NonNull NotificationData notificationData) {
        ...
        if (isTemplateEmail(notificationData)) {
            ...
            mailService.sendSimpleEmail(notificationData.recipients(), notificationData.subject(), notificationData.message());
    ...
    private void sendTemplateEmail(NotificationData notificationData) {
        ...
        var placeholders = (Map<String, Object>) notificationData.metadata().get("placeholders");
        try {
            mailService.sendEmailUsingTemplate(template, notificationData.recipients(), notificationData.subject(), placeholders);
    ...
    private void requireValidNotificationData(NotificationData notificationData) {
        ...
        if (StringUtils.isBlank(notificationData.message()) && StringUtils.isBlank(MapUtils.getString(notificationData.metadata(), EMAIL_TEMPLATE_METADATA_KEY))) {
