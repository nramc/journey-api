...
import com.github.nramc.dev.journey.api.account.web.users.dto.User;
import com.github.nramc.dev.journey.api.account.web.users.dto.UserConverter;
...
class FindUsersResource {
    ...
    ResponseEntity<User> findMyAccount(Authentication authentication) {
